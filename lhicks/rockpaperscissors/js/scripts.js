...
function compGen()//executes after each choice by the player
{
	...
	{
		case rock:
			document.getElementById("enemyChoice").innerHTML='<img src="img/rock2.jpg" class="img-responsive">';
			document.getElementById("enemyChoiceTxt").innerHTML="Computer chooses rock!";
		break;
		case paper:
			document.getElementById("enemyChoice").innerHTML='<img src="img/paper2.jpg" class="img-responsive">';
			document.getElementById("enemyChoiceTxt").innerHTML="Computer chooses paper!";
		break;
		case scissors:
			document.getElementById("enemyChoice").innerHTML='<img src="img/scissors2.jpg" class="img-responsive">';

...
function playerRock() {
	var picture = "<div class='picture'>" + "<img class='pics' src='pictures/rock.jpg'>" + "</div>"
...
function playerPaper() {
	var picture = "<div class='picture'>" + "<img class='pics' src='pictures/paper.jpg'>" + "</div>"
	document.getElementById("imgdiv").innerHTML = picture; //Controls the picture that shows after clicking what element you want
...
function playerScissors() {
	var picture = "<div class='picture'>" + "<img class='pics' src='pictures/scissors.jpg'>" + "</div>"
	document.getElementById("imgdiv").innerHTML = picture; //Controls the picture that shows after clicking what element you want
